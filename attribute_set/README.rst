...
.. |badge3| image:: https://img.shields.io/badge/github-akretion%2Fodoo--pim-lightgray.png?logo=github
    :target: https://github.com/akretion/odoo-pim/tree/12.0/attribute_set
...
`feedback <https://github.com/akretion/odoo-pim/issues/new?body=module:%20attribute_set%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `akretion/odoo-pim <https://github.com/akretion/odoo-pim/tree/12.0/attribute_set>`_ project on GitHub.
